...
var usersModule_1 = require("./modules/usersModule");
...
container.bind(types_1.default.AuthenticationModule).to(authenticationModule_1.default);
container.bind(types_1.default.UserModule).to(usersModule_1.default);
