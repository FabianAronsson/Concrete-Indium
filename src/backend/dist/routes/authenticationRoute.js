...
var authenticationModule_1 = require("../modules/authenticationModule");
var types_1 = require("../types");
var AuthenticationRoute = (function () {
    function AuthenticationRoute(authenticationModule, userModule) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4, this._authenticationModule.createToken(user)];
                    case 2:
                        accessToken = _a.sent();
    ...
    AuthenticationRoute = __decorate([
        ...
        __param(0, inversify_1.inject(types_1.default.AuthenticationModule)),
        __param(1, inversify_1.inject(types_1.default.UserModule)),
        __metadata("design:paramtypes", [authenticationModule_1.default, Object])
    ], AuthenticationRoute);
